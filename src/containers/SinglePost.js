      ...
      <div className='wrapper'>
        ...
        <div className='col-7-12'>
          <div className='offset-1 newscontent'>
            ...
            <SbEditable content={data.content}>
              <Link to={`/${props.lng}/blog`} className='button button--green news__button '>
                <img className='news__button--arrow' src={ArrowWhite} alt='' />
                {data.content.back_to_all_news || 'Back to all posts'}
              </Link>
            </SbEditable>
          </div>
        </div>
        <div className='col-1-3'>
          <div className='most_recent'>
            ...
            {latest.map(item => (
              <Link to={`${item.slug}`} key={item.id} className='most_recent__item'>
